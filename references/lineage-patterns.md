...
Use this file when the user requests a lineage trace ("trace this column", "what uses this measure", "impact of changing X") or cascading impact analysis before schema changes. On-demand — not automatic.
...
Auto-generate this for documentation output when user requests "document this model":
