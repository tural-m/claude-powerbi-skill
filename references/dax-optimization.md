...
Use this file when the user requests a performance audit ("audit performance", "why is this slow") or when DAX anti-patterns are detected inline during generation. On-demand — not automatic.
...
Run through this during a performance audit:
